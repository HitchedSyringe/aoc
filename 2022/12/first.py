"""
Solution to Part 1 of Day 12 of Advent of Code 2022.
...
start, end = find_start_and_end_points(heightmap)

print("Steps required: ", calculate_steps(start, end, heightmap))
